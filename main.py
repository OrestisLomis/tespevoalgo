...
class r0123456:
	...
	def optimize(self, filename, plot_name='plot'):
		...
		print(bestSolution)
		print(convert_repr_to_cycle(bestSolution)[0])
		print(convert_repr_to_cycle(bestSolution)[1])
		print(convert_repr_to_cycle(bestSolution)[2])
		print(convert_repr_to_cycle(bestSolution)[3])
		time_diff = end - start
...
# print(convert_repr_to_cycle([38, 1, 11, 17, 22, 46, 10, 0, 37, 12, 41, 25, 21, 48, 4, 47, 16, 35, 13, 26, 44, 27, 14, 34, 18, 2, 15, 29, 20, 30, 49, 31, 3, 19, 39, 36, 24, 7, 40, 45, 8, 28, 32, 43, 5, 6, 9, 23, 33, 42]))
mytest = r0123456()
